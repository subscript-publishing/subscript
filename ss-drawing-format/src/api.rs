...
// pub fn parse_file<P: AsRef<Path>>(file_path: P) -> Result<crate::ss_drawing::format::CanvasDataModel, String> {
//     // let value: serde_json::Value = plist::from_file(file_path.as_ref())
//     //     .map_err(|x| format!("{:?}", x))?;
//     // let model = serde_json::from_value::<crate::ss_drawing::format::CanvasDataModel>(value)
//     //     .map_err(|x| format!("{:?}", x))?;
//     // Ok(model)
//     unimplemented!()
// }
