...
# CRATE NAME
#―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
CRATE_AR_ARCHIVE_NAME_SRC="libss_notebook_format_c_api.a"
CRATE_AR_ARCHIVE_NAME_DEST_IOS="libss_notebook_format_c_api.a"
CRATE_AR_ARCHIVE_NAME_DEST_MACOS="libss_notebook_format_c_api.a"
CRATE_AR_ARCHIVE_NAME_DEST_CATALYST="libss_notebook_format_c_api.a"
...
if [ "$MACOS_ONLY" = "YES" ]; then
	build_macos
elif [ "$IOS_ONLY" = "YES" ]; then
	build_ios
elif [ "$CATALYST_ONLY" = "YES" ]; then
	build_catalyst
else
	build_macos
	build_ios
