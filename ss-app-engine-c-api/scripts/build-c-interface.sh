...
# CRATE NAME
#―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
CRATE_AR_ARCHIVE_NAME_SRC="libss_app_engine_c_api.a"
CRATE_AR_ARCHIVE_NAME_DEST_IOS="libss_app_engine_c_api.a"
CRATE_AR_ARCHIVE_NAME_DEST_MACOS="libss_app_engine_c_api.a"
CRATE_AR_ARCHIVE_NAME_DEST_CATALYST="libss_app_engine_c_api.a"
...
SWIFT_INCLUDE_HEADER_FILE_PATH="$SWIFT_C_INCLUDE_DIR/ss-app-engine.h"
