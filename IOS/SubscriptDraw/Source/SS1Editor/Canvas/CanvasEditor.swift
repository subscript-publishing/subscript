...
fileprivate let DARK_HEADER_BACKGROUND_COLOR: UIColor = #colorLiteral(red: 0.210621506, green: 0.210621506, blue: 0.210621506, alpha: 1)
fileprivate let DARK_HEADER_BORDER_COLOR: UIColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
fileprivate let DARK_PANEL_GUTTER_COLOR: UIColor = #colorLiteral(red: 0.1331654787, green: 0.1331654787, blue: 0.1331654787, alpha: 1)

fileprivate let LIGHT_HEADER_BACKGROUND_COLOR: UIColor = #colorLiteral(red: 0.8039215803, green: 0.8039215803, blue: 0.8039215803, alpha: 1)
fileprivate let LIGHT_HEADER_BORDER_COLOR: UIColor = #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)
fileprivate let LIGHT_PANEL_GUTTER_COLOR: UIColor = #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)
...
fileprivate struct DrawingRootView: View {
    ...
    private var header: some View {
        HStack(alignment: .center, spacing: 0) {Spacer()}
            ...
            .background(Color(colorScheme == .dark ? DARK_HEADER_BACKGROUND_COLOR : LIGHT_HEADER_BACKGROUND_COLOR))
            .border(width: 0.5, edges: isFirstChild ? [] : [.top])
