...
\note{
   ...
   \ul{
      ...
      \li{\note{
         ...
         \img[center, src="../static/drawings/matrix/trinagle-def-of-a-vector.png", width="300px"]
      }}
...
\grid[col="2"]{
   ...
   \note[boxed]{
      ...
      \img[src="../static/drawings/matrix/Definition-of-Vector-Addition.png", center, width="300px"]\hr\p{Given some vectors \{\vec{u}} and \{\vec{v}}, the vector \{\vec{u} - \vec{v}} is the vector that points from the head of \{\vec{v}} to the head of \{\vec{u}}}
...
\grid[col="3"]{
   \note[boxed]{
      ...
      \hr\img[center, src="../static/drawings/matrix/unit-vectors.png", width="200px"]
   }
   \note[boxed]{
      \h3{Orthogonal}
...
\note{
   \img[src="../static/drawings/matrix/Direction-Cosines-Direction-Angles-of-a-Vector.png", center, width="300px"]\p[center]{Where}
   \equation{
...
\grid[col="2"]{
   \note[boxed]{
      ...
      \img[src="../static/drawings/matrix/3x3-determinant.png", width="400px", center]\note[boxed]{
