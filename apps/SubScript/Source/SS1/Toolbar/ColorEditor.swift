...
fileprivate struct HueColorSlider: View {
...
fileprivate struct SaturationColorSlider: View {
    @Binding var color: UI.ColorType.HSBA
    private var sampleColors: Array<Color> {
        var xs: Array<Color> = []
        for i in stride(from: 0.0, through: 1.0, by: 0.05) {
...
fileprivate struct BrightnessColorSlider: View {
    @Binding var color: UI.ColorType.HSBA
    private var sampleColors: Array<Color> {
        var xs: Array<Color> = []
        for i in stride(from: 0.0, through: 1.0, by: 0.05) {
...
fileprivate struct AlphaColorSlider: View {
    @Binding var color: UI.ColorType.HSBA
    private var sampleColors: Array<Color> {
        var xs: Array<Color> = []
        for i in stride(from: 0.0, through: 1.0, by: 0.05) {
